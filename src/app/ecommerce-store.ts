...
export const EcommerceStore = signalStore(
  ...
  },
  {
    ...
    price: 89.99,
    imageUrl: 'https://data.gioiapura.it/imgprodotto/orologio-smartwatch-smarty-unisex-sw071b_814548_zoom.jpg',
    rating: 4.2,
    reviewCount: 60,
    inStock: true,
    category: 'elettronica',
  ...
  },
  {
    ...
    price: 69.99,
    imageUrl: 'https://maestriciccone.com/cdn/shop/files/sneaker-uomo-blu-avellino-ciccone-1.jpg?v=1775642205&width=1200',
    rating: 4.3,
    reviewCount: 110,
    inStock: false,
    category: 'abbigliamento',
  ...
  },
  {
    ...
    price: 159.99,
    imageUrl: 'https://www.indux.it/media/image/60/a3/77/Aspirapolvere-Numatic-NBV-190-senza-fili-min_600x600.jpg',
    rating: 4.4,
    reviewCount: 65,
    inStock: true,
    category: 'casa',
  ...
  },
  {
    ...
    price: 29.99,
    imageUrl: 'https://evergreenweb.it/wp-content/uploads/2023/02/01_01.jpg',
